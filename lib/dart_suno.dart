...
class DartSuno {
  ...
  Future<SunoResponse> generateMusic({
    ...
    if (gptDescriptionPrompt != null) body['gpt_description_prompt'] = gptDescriptionPrompt;
  ...
  Future<SunoTaskResponse> pollTaskUntilComplete({
    ...
    throw TimeoutException('Task polling timeout after ${timeout.inMinutes} minutes', timeout);
  }
...
class SunoTaskData {
  ...
  factory SunoTaskData.fromJson(Map<String, dynamic> json) {
    return SunoTaskData(
      ...
      data: json['data'] != null 
          ? (json['data'] is List 
              ? (json['data'] as List<dynamic>).map((item) => SunoSongData.fromJson(item as Map<String, dynamic>)).toList()
              : null)
          : null,
    );
  }
...
class SunoChatResponse {
  ...
  factory SunoChatResponse.fromJson(Map<String, dynamic> json) {
    return SunoChatResponse(
      ...
      choices: (json['choices'] as List).map((item) => ChatChoice.fromJson(item)).toList(),
